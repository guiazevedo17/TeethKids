...
public final class FragmentAddressRegisterSignUpBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final AppCompatImageButton btnBackAddressRegisterSignUp;
  ...
  @NonNull
  public final AppCompatTextView tbAddressRegisterSignUp;

  private FragmentAddressRegisterSignUpBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageButton btnBackAddressRegisterSignUp,
      ...
      @NonNull TextInputLayout ilStreet, @NonNull AppCompatTextView tbAddressRegisterSignUp) {
    this.rootView = rootView;
    this.btnBackAddressRegisterSignUp = btnBackAddressRegisterSignUp;
    ...
    this.tbAddressRegisterSignUp = tbAddressRegisterSignUp;
  }
  ...
  @NonNull
  public static FragmentAddressRegisterSignUpBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAddressRegisterSignUpBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_address_register_sign_up, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAddressRegisterSignUpBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btnBackAddressRegisterSignUp;
      AppCompatImageButton btnBackAddressRegisterSignUp = ViewBindings.findChildViewById(rootView, id);
      if (btnBackAddressRegisterSignUp == null) {
        break missingId;
      }
      ...
      id = R.id.tbAddressRegisterSignUp;
      AppCompatTextView tbAddressRegisterSignUp = ViewBindings.findChildViewById(rootView, id);
      if (tbAddressRegisterSignUp == null) {
        break missingId;
      }

      return new FragmentAddressRegisterSignUpBinding((ConstraintLayout) rootView,
          btnBackAddressRegisterSignUp, btnConcludeAddressRegister, etCity, etComplement, etName,
          etNeighborhood, etNumber, etPostalCode, etState, etStreet, ilCity, ilComplement, ilName,
          ilNeighborhood, ilNumber, ilPostalCode, ilState, ilStreet, tbAddressRegisterSignUp);
    }
