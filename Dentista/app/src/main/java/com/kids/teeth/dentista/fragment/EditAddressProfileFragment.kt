...
import com.kids.teeth.dentista.databinding.FragmentEditAddressProfileBinding
import com.kids.teeth.dentista.model.Address

class EditAddressProfileFragment : Fragment() {

    private var _binding: FragmentEditAddressProfileBinding? = null
    private val binding: FragmentEditAddressProfileBinding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditAddressProfileBinding
            .inflate(
                inflater,
                container,
                false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCancelEditAddressProfile.setOnClickListener {
            findNavController().navigate(R.id.action_AddressRegisterProfileFragment_to_AddressesListProfileFragment)
        }

        binding.btnConcludeEditAddressProfile.setOnClickListener {
